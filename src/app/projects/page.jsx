...
const FeaturedProject = ({type,title, summary, img, link, github}) =>{
    ...
    return (
        ...
        <div className='relative'>
         <div className='top-0 -right-3 w-[100%] h-[103%] rounded-[2.5rem] bg-dark absolute rounded-br-3xl dark:bg-light'/>
...
const Project = ({title, type, img, link, github}) =>{
    ...
    return (
        ...
        <div className='relative'>
         <div className='top-0 -right-3 w-[100%] h-[103%] rounded-[2rem] bg-dark absolute rounded-br-3xl dark:bg-light'/>
