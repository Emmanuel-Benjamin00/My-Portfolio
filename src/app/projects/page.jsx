...
const FeaturedProject = ({type,title, summary, img, link, github}) =>{
    ...
    return (
        ...
        <div className='relative'>
         <div className='top-0 -right-3 w-[100%] h-[103%] rounded-[2.5rem] bg-dark absolute rounded-br-3xl'/>

         <article className='w-full flex items-center justify-between rounded-3xl border border-solid  border-dark
         bg-light shadow-2xl p-12 relative z-1 rounder-br-2xl'>       
...
const Project = ({title, type, img, link, github}) =>{
    ...
    return (
        ...
        <div className='relative'>
         <div className='top-0 -right-3 w-[100%] h-[103%] rounded-[2rem] bg-dark absolute rounded-br-3xl'/>
