...
const FeaturedProject = ({type,title, summary, img, link, github}) =>{
    ...
    return (
        ...
        <div className='relative'>
         <div className='top-0 -right-3 w-[100%] h-[103%] rounded-[2.5rem] bg-dark absolute rounded-br-3xl dark:bg-light xs:-right-2 sm:h-[102%] xs:w-full xs:rounded-[1.5rem]'/>

         <article className='w-full flex items-center justify-between rounded-3xl border border-solid  border-dark
         bg-light shadow-2xl p-12 relative z-1 rounder-br-2xl dark:bg-dark dark:border-light
          lg:flex-col lg:p-8 xs:rounded-2xl xs:rounder-br-3xl xs:p-4
          '>       
...
const Project = ({title, type, img, link, github}) =>{
    ...
    return (
        ...
        <div className='relative'>
         <div className='top-0 -right-3 w-[100%] h-[103%] rounded-[2rem] bg-dark absolute rounded-br-3xl dark:bg-light md:-right-2 md:w-[101%] xs:h-[102%] xs:rounded-[1.5rem]'/>
        <article className='w-full flex flex-col items-center justify-center rounded-2xl border
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4 '>
                <span className='text-primary font-medium text-xl dark:text-primaryDark lg:text-lg nd:text-base'>{type}</span>
                <Link href={link} target="_blank" className='hover:underline underline-offset-2'>
