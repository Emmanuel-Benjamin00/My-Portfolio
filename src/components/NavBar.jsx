  ...
  return (
    <Link href={href} className={`${className} relative group`}>
     ...
     <span  className={`h-[1px] inline-block bg-dark  absolute left-0 
          -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 ${pathname === href ? "w-full" : "w-0"}`}>&nbsp;</span>
    </Link>
  )
}
  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between'>
        ...
        <nav className='flex items-center  justify-center flex-wrap'>
            ...
            <motion.a href='https://www.pinterest.com/' target={'_blank'}  className='w-6 mx-3'
              whileHover={{ y: -2 }}
